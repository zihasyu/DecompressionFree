#include "../../../include/Thread/design3_D.h"
#include <cstdint>
...
void Design3_D::ProcessTrace()
{
    ...
    ThreadSafeQueue<RestoredChunk3D> chunkQueue;
...
uint8_t *Design3_D::xd3_encode_buffer(const uint8_t *targetChunkbuffer, size_t targetChunkbuffer_size, const uint8_t *baseChunkBuffer, size_t baseChunkBuffer_size, size_t *deltaChunkBuffer_size, uint8_t *tmpbuffer)
{
...
void Design3_D::StatsHit(uint64_t FatherID, uint64_t HitID, uint64_t BasechunkID)
{
...
Chunk_t Design3_D::CutGreedy(uint64_t BasechunkId, const Chunk_t Targetchunk)
{
