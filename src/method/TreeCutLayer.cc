#include "../../include/Tree/TreeCutLayer.h"

TreeCutLayer::TreeCutLayer()
{
...
void TreeCutLayer::ProcessTrace()
{
    string tmpChunkHash;
...
uint8_t *TreeCutLayer::xd3_encode_buffer(const uint8_t *targetChunkbuffer, size_t targetChunkbuffer_size, const uint8_t *baseChunkBuffer, size_t baseChunkBuffer_size, size_t *deltaChunkBuffer_size, uint8_t *tmpbuffer)
{
...
void TreeCutLayer::StatsHit(uint64_t FatherID, uint64_t HitID, SuperFeatures sfs)
{
