#include "../../include/Tree/TreeCut.h"
...
Chunk_t TreeCut::CutGreedy(uint64_t BasechunkId, const Chunk_t Targetchunk)
{
...
uint8_t *TreeCut::xd3_encode_buffer(const uint8_t *targetChunkbuffer, size_t targetChunkbuffer_size, const uint8_t *baseChunkBuffer, size_t baseChunkBuffer_size, size_t *deltaChunkBuffer_size, uint8_t *tmpbuffer)
{
