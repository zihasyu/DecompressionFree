#include "../../include/AllGreedyLRU.h"

AllGreedyLRU::AllGreedyLRU()
{
...
void AllGreedyLRU::ProcessTrace()
{
    string tmpChunkHash;
...
Chunk_t AllGreedyLRU::FindBest(SuperFeatures SF, const Chunk_t &Targetchunk)
{
...
uint8_t *AllGreedyLRU::xd3_encode_buffer(const uint8_t *targetChunkbuffer, size_t targetChunkbuffer_size, const uint8_t *baseChunkBuffer, size_t baseChunkBuffer_size, size_t *deltaChunkBuffer_size, uint8_t *tmpbuffer)
{
